...
urlpatterns = [
    ...
    path('upload_data', task.upload_data.upload_data),
    ...
    path('distribute/<int:task_id>', task.distribute.distribute_task),
    ...
    path('redistribute/<int:task_id>', task.distribute.redistribute_task),
    path('to_agent/<int:task_id>', task.distribute.to_agent),
    path('distribute_to_user/<int:task_id>/<int:user_id>', task.distribute.distribute_to_user),
